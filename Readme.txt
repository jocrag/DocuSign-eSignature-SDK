...
Transactions are completely defined on the host application side by generating XML  envelopes  that contain a PDF and the XML signing instructions. Because the transactions could be defined on the fly by the host application, the workflow and processing can be completely defined by the developer.
...
Full Documentation can be downloaded or viewed online by going here: http://www.docusign.com/developers-center/documentation
...
The SDK includes samples in Java, .NET, Ruby and PHP.
...
To get started, go to our DevCenter (http://www.docusign.com/devcenter/) and arrange for a demo account and credentials for your project.  Professional Services is also available to help define and implement your project fast.
