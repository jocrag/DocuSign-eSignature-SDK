...
public class DocumentType implements java.io.Serializable {
    ...
    public static final DocumentType SUMMARY = new DocumentType(_SUMMARY);
    public static final DocumentType CONTENT = new DocumentType(_CONTENT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.docusign.net/API/3.0", "DocumentType"));
    }
    /**
